	...
	<div class="container">
		<div class="col-lg-8 col-lg-offset-3">
			<div>
			    ...
			    <h1 style="color: #008000">Update Info</h1>
              ...
              <div class="container">
                     ...
                     <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type=text id="city" name="city" class="form-control input-sm" placeholder="City" value="${attribs.city}"> 
                           </div>
                           <div id='etl'>
                     ...
                     <div class="col-md-2">
                           <div class="form-group">
                              ...
                              <input type=text id="state" name="state" class="form-control input-sm" placeholder="State" value="${attribs.city}"> 
                           </div>
                           <div id='etl'>
                     ...
                     <div class="col-md-1">
                           <div class="form-group">
                              ...
                              <input type=text id="zip" name="zip" class="form-control input-sm" placeholder="Zip Code" value="${attribs.zip}"> 
                           </div>
                           <div id='etl'>
                     ...
                     <div class="col-md-12" >
		                           <div class="form-group">		                           
					                   ...
					                   <a href="javascript:goBack();" class="btn btn-primary" role="button">Cancel</a>
