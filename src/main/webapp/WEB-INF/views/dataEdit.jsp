	...
	<form id="editUser" method="post"  action="saveUser">
      ...
      <div class="contact-form">
              <div class="container">
                     ...
                     <div class="col-md-3">
                           <div class="form-group">
                              <label for="tl" id='etl'> Zip Code</label>
                              <input type=text id="zip" name="zip" class="form-control input-sm" placeholder="Zip" value="${attribs.zip}"> 
                           </div>
                           <div id='etl'>                           
                           </div>
                     </div>
